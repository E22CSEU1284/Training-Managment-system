...
int countNoofdays(int date1[], int date2[]) {
    queue<long int> dayCount1;
    dayCount1.push(date1[2] * 365);
    dayCount1.push(monthDays[date1[1]]);
    dayCount1.push(date1[0]);
    dayCount1.push(countLeapYearDays(date1));

    queue<long int> dayCount2;
    dayCount2.push(date2[2] * 365);
    dayCount2.push(monthDays[date2[1]]);
    dayCount2.push(date2[0]);
    dayCount2.push(countLeapYearDays(date2));

    long int diff = 0;
    while (!dayCount1.empty() && !dayCount2.empty()) {
        diff += abs(dayCount1.front() - dayCount2.front());
        dayCount1.pop();
        dayCount2.pop();
    }
...
public:
    void createSchedule()      
    {
        ...
        ofstream f1("/Users/sumit/Desktop/sumit/data/schedule.csv", ios::app);
    ...
    void updateSchedule()       
    {
        ...
        file.open("/Users/sumit/Desktop/sumit/data/schedule.csv", ios::in);
        int count = 0;
        vector<string> v;
        ...
        file.open("/Users/sumit/Desktop/sumit/data/schedule.csv", ios::out | ios::trunc);
    ...
    void allotTrainer()      
    {
        ...
        ifstream f2("/Users/sumit/Desktop/sumit/data/schedule.csv");
        while (f2 >> batchID >> technology >> startDate >> endDate >> nod >> venueDetail >> nop >> month)
        {
            ...
            ofstream f3("/Users/sumit/Desktop/sumit/data/trainerallotment.csv", ios::app);
    ...
    void generateReport()       
    {
        ...
        ifstream f3("/Users/sumit/Desktop/sumit/data/schedule.csv");
